...
export function TechnologySection() {
  ...
  const descriptionText =
    "Evergreen goods are made from natural, durable materials and built by hands that care. From the kitchen table to the mountain trail, our essentials are designed to be used, repaired, and passed down — beautiful in the home and ready for the outdoors."
            ...
            >
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center px-6 text-center">
                <h2 className="max-w-3xl font-medium leading-tight tracking-tight text-white md:text-5xl lg:text-7xl text-5xl">
                  {["Home", "Meets", "Trail."].map((word, index) => {
